...
#define ssid "a9c6d4"   //SSID
#define password "281117087"  //Contrseña de la red
#define host "192.168.0.28"  //Mi IP
//------------
...
//float temp = 100.0*(3.3*analogRead(A0)/1024);
 ...
 client.print(String("POST http://localhost/iot/proyecto.php?") + 
                          ("&temperatura=") + temp +               
                          " HTTP/1.1\r\n" +
                 "Host: " + host + "\r\n" +
                 "Connection: close\r\n\r\n");
...
String path = "/Test";
  ...
  json.set("TempereraturaAle" + String(1), temp);
